  ...
  return (
    <Layout title="Home" description={`${title} - ${subtitle}`}>
      ...
      <Section linebreak>
        ...
        <p className="my-2">
          I spend most of my time as a frontend developer on Ostmodern&apos;s Skylark CMS using
          React.js. Sometimes I use Node.js, Docker, Kubernetes and Golang and I&apos;m currently
          experimenting with Serverless technologies on AWS and Azure.
        </p>
        <p className="my-2">
